...
function App() {
    ...
    const clickedYes = () => {
        alert(
            "Looks like you couldn’t resist saying yes, Sherry! You’ve officially made my Valentine’s Day special. An email has been sent to me with your response, and I can't wait to celebrate with you Virtually till summer"
        );
    };
